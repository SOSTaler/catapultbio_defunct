...
* Genome assembly on laptop/RaspberryPi [INRIA Video](https://www.youtube.com/watch?v=Ppc0j-nrEIQ) using [MINIA](https://gatb.inria.fr/software/minia/) from the [GATB package](https://gatb.inria.fr/software/). Use with MinION or output of Illumina sequencers HiSeq/MiSeq. Interesting: Discover SNPs and indels from non-assembled reads without reference genome 	[DiscoSNP++](https://gatb.inria.fr/software/discosnp/)
------------------
