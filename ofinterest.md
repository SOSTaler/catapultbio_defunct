...
* MEMORY & Epigenetics: [It is widely believed that rapid and reversible DNA methylation is essential for the stability of long-term memory but still very little is known how synaptic signals can induce changes in DNA-methylation to elicit enduring alterations in plasticity-related gene expression (Bayraktar & Kreutz, 2018a, b; Campbell & Wood, 2019; Day & Sweatt, 2010; Miller & Sweatt, 2007; Guo et al, 2011). In addition, aberrant DNA methylation has been implicated in neuropsychiatric diseases including schizophrenia, bipolar, and major depression disorders (Bayraktar & Kreutz, 2018; Mill et al, 2008; Murgatroyd et al, 2009).](https://www.biorxiv.org/content/10.1101/602151v1.full)
